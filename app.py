...
def signup():
    ...
    r = requests.post(
        ...
        json={
            ...
            "html": (
                f"<h2>Yobi1 verification</h2>"
                f"<p>Your verification code is <strong>{code}</strong>.</p>"
                f"<p>Do not share this code with any person or application.</p>"
            )
        },
        timeout=15
    )
    ...
    <body style="font-family:Arial;text-align:center;padding:50px">
        ...
        <form method="post">
            <input
                ...
                placeholder="0000"
                required
                style="font-size:24px;text-align:center;padding:12px;width:160px"
            >
            <br><br>
            <button type="submit" style="padding:12px 30px">Verify</button>
        </form>
    </body>
    </html>
    """
